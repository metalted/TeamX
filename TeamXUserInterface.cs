...
namespace TeamX
{
    public static class TeamXUserInterface
    {
        public static Action TeamkistButtonPressed;
        ...
        {
            //Remove any previous subscribers.
            TeamkistButtonPressed = null;
